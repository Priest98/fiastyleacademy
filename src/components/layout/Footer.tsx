  ...
  return (
    <footer className="bg-neutral-50 text-black border-t border-black/5 relative overflow-hidden texture-grain">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 pt-24 pb-12">
        <div className="grid gap-16 md:grid-cols-12 mb-20">
          ...
          <div className="md:col-span-6 space-y-8">
            ...
            <div className="flex gap-10 pt-4">
              {socials.map(s => (
                ...
                >
                  <span className="text-[8px] uppercase tracking-[0.25em] text-neutral-400 group-hover:text-gold transition-colors">{s.name}</span>
                  <span className="text-xs font-light text-neutral-800 border-b border-black/0 group-hover:border-gold group-hover:text-gold transition-all pb-1 flex items-center gap-1">
                    {s.label}
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <ul className="space-y-4 text-[11px] uppercase tracking-[0.2em] font-light">
              ...
              <li>
                <Link to="/courses" className="text-neutral-800 hover:text-gold transition-colors duration-300 flex items-center gap-2 group">
                  <span className="h-[1px] w-0 bg-gold group-hover:w-3 transition-all duration-300" />
                  Programs of Study
                </Link>
              </li>
              <li>
                <Link to="/work" className="text-neutral-800 hover:text-gold transition-colors duration-300 flex items-center gap-2 group">
                  <span className="h-[1px] w-0 bg-gold group-hover:w-3 transition-all duration-300" />
                  Student Showcase
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-neutral-800 hover:text-gold transition-colors duration-300 flex items-center gap-2 group">
                  <span className="h-[1px] w-0 bg-gold group-hover:w-3 transition-all duration-300" />
                  Inquiries
                </Link>
              </li>
        ...
        <div className="select-none pointer-events-none text-center border-t border-black/5 pt-10 mt-10">
          <h2 className="font-display text-[9vw] leading-none text-neutral-200/60 uppercase tracking-widest font-bold">
            FIATSTYLE
          </h2>
        </div>

        {/* Bottom Bar */}
        <div className="border-t border-black/5 pt-8 mt-8 flex flex-col sm:flex-row gap-4 justify-between text-[9px] uppercase tracking-[0.3em] text-neutral-500 font-light">
