    ...
    <div className="min-h-screen bg-background text-foreground flex">
      <aside className="w-64 shrink-0 border-r hairline p-6 sticky top-0 h-screen hidden lg:flex flex-col">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-display text-lg">Atelier<span className="text-gold">.</span></span>
        </Link>
        ...
        <div className="mt-auto rounded-xl bg-surface p-4 scanlines">
          <p className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Cohort</p>
          <p className="font-display text-xl mt-1">Spring '26</p>
          <p className="text-xs text-muted-foreground mt-2">Week 3 of 12</p>
        </div>
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="lg:hidden flex items-center justify-between p-4 border-b hairline">
          <Link to="/" className="flex items-center gap-2"><Sparkles className="h-4 w-4 text-gold"/><span className="font-display">Atelier</span></Link>
